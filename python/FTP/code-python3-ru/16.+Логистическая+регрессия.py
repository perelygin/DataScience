...
from lib.gradient_descent import maximize_stochastic, maximize_batch
from lib.working_with_data import rescale
from lib.machine_learning import train_test_split
...
def logistic_log_gradient_i(x_i, y_i, beta):
    ...
    соответствующий i-ой точке данных"""
...
if __name__ == "__main__":
    ...
    data = list(map(list, data)) # конвертировать кортежи в списки

    x = [[1] + row[:2] for row in data] # каждый элемент - это [1, стаж, зарплата]
    y = [row[2] for row in data]        # каждый элемент - это оплаченный_аккаунт
    ...
    # максимизируем логарифмическое правдоподобие на обучающих данных
    ...
    # и максимизировать при помощи градиентного спуска
    beta_hat = maximize_batch(fn, gradient_fn, beta_0)

    print("пакетный коэффициент beta", beta_hat)
    ...
    print("стохастический коэффициент beta", beta_hat)
